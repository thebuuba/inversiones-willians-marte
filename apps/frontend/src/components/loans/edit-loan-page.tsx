  ...
  if (!loan) {
    return (
      <main className="min-h-screen bg-page p-5">
        <div className="mx-auto max-w-2xl rounded-panel border border-border-soft bg-card p-6 shadow-card">
  ...
  return (
    <main className="min-h-screen bg-page">
      <div className="mx-auto max-w-2xl px-6 py-8">
        ...
        <div className="rounded-3xl bg-card shadow-card border border-border-soft">
          ...
          <div className="space-y-6 px-8 py-6">
            {error && (
              <div className="rounded-control-comfortable bg-red-50 px-4 py-3 text-sm text-red-600">{error}</div>
            )}

            <div className="grid grid-cols-2 gap-4">
              <div className="rounded-control-comfortable bg-surface-subtle px-4 py-3">
            ...
            <div>
              ...
              <select
                ...
                className="w-full appearance-none rounded-control-comfortable border border-primary-border bg-card px-4 py-2.5 text-sm text-text-primary outline-none focus:border-primary-accent focus:ring-1 focus:ring-primary-accent"
              >
                {statusOptions.map((o) => (
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-control-comfortable border border-primary-border bg-card px-4 py-2.5 text-sm text-text-primary outline-none focus:border-primary-accent focus:ring-1 focus:ring-primary-accent"
              />
            ...
            <section className="overflow-hidden rounded-panel border border-primary-border">
              ...
              {lateFeeEnabled && (
                <div className="grid gap-4 border-t border-primary-border p-4 sm:grid-cols-2">
                  <label>
                    ...
                    <select
                      className="w-full rounded-control-comfortable border border-primary-border bg-card px-4 py-2.5 text-sm text-text-primary outline-none focus:border-primary-accent"
                      onChange={(event) =>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full resize-none rounded-control-comfortable border border-primary-border bg-card px-4 py-2.5 text-sm text-text-primary outline-none focus:border-primary-accent focus:ring-1 focus:ring-primary-accent"
              />
            </div>
          </div>
