          ...
          >
            ...
            <div className="flex-1 px-6 py-5 pb-32">
              ...
              >
                ...
                {data.status !== 'PENDING' && (
                  <p className="mt-1.5 text-xs font-bold text-[#6F8076]">
            ...
            {data.status === 'PENDING' && (
              <div className="fixed bottom-0 right-0 w-full max-w-[540px] border-t border-[#DDEBE3] bg-white px-6 py-4">
                <div className="mb-3 grid grid-cols-2 gap-3">
                  <button
                    className="flex h-10 items-center justify-center gap-2.5 rounded-full border border-[#DDEBE3] bg-white text-sm font-bold text-[#173D2C] transition hover:bg-[#F3FAF6]"
                    onClick={handlePrint}
                    type="button"
                  >
