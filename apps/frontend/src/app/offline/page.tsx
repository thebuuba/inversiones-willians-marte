...
export default function OfflinePage() {
  return (
    <main className="flex min-h-screen items-center justify-center bg-page px-5 py-10">
      <section className="w-full max-w-md rounded-2xl border border-primary-border bg-card p-8 text-center shadow-card">
        ...
        <Link
          href="/inicio"
          className="mt-7 inline-flex h-12 items-center justify-center rounded-xl bg-primary px-6 text-base font-bold text-white shadow-action transition-colors hover:bg-primary-hover"
        >
          Volver al inicio
        </Link>
      </section>
